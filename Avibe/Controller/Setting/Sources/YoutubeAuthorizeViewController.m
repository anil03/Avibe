...
@interface YoutubeAuthorizeViewController () <UIWebViewDelegate, NSURLConnectionDataDelegate>
...
//    [self setAutoresizingMask:_parentView.autoresizingMask];
    ...
    [self.webView setAutoresizingMask:_parentView.autoresizingMask];
...
//    [_parentView bringSubviewToFront:self];
    //Current show method for side menu
}
